...
-----------------------------------------------------------------------------
*/
#ifndef ZV3D_ERRORCODES_H
#define ZV3D_ERRORCODES_H
...
enum ErrorCode {
    kERRC_UNKNOWN = -1,
    kERRC_NO = 0,               // no error, all ok
    kERRC_FILE_NOT_FOUND = 1,
    kERRC_BAD_FILENAME,
    kERRC_NOT_ENOUGH_BUF_SPACE,
    kERRC_VALUE_OUT_OF_RANGE,
    kERRC_INVALID_PTR,
    kERRC_NOT_ENOUGH_DATA,
    kERRC_MALFORMED_DATA
};

} // end of Zv3D
#endif // ZV3D_ERRORCODES_H

...
-----------------------------------------------------------------------------
*/
#ifndef ZV3DD_STATIC_ALLOC_SINGLETON_H
#define ZV3DD_STATIC_ALLOC_SINGLETON_H
/** @file Zv3DStaticAllocSingleton.h
...
private:
    ...
    // not allowed
    StaticAllocatedSingleton(const StaticAllocatedSingleton<T, BufferSize>&);
    StaticAllocatedSingleton& operator=(const StaticAllocatedSingleton<T, BufferSize>&);

    static T* sInstance_;
    static unsigned char sBuffer_[BufferSize];
};

//-----------------------------------------------------------------------------
template <typename T, int BufferSize>
T* StaticAllocatedSingleton<T, BufferSize>::sInstance_ = 0;

//-----------------------------------------------------------------------------
template <typename T, int BufferSize>
unsigned char StaticAllocatedSingleton<T, BufferSize>::sBuffer_[BufferSize];

} // end of Zv3D
#endif // ZV3DD_STATIC_ALLOC_SINGLETON_H
